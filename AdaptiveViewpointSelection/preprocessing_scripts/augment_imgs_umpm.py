...
if __name__ == '__main__':
	...
	if ISTRAIN:
		...
		croppedImgDir = DATA_ROOT + 'validation_cropped_marg20/'
		targetDir = DATA_ROOT + 'validation_bulk_marg20/'	
	else:
		raise NameError('ERROR: should either select train/test/validation')
